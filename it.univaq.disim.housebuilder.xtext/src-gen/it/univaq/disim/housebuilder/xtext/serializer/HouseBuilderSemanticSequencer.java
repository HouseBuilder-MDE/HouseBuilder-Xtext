...
public class HouseBuilderSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	 ...
	 *
	 * Constraint:
	 *     (name=EString type=DeviceType? model=EString?)
	 */
	 ...
	 *
	 * Constraint:
	 *     (name=EString doorsNumber=EInt? (height=EFloat width=EFloat)?)
	 */
